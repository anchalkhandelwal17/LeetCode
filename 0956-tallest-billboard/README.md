<h2><a href="https://leetcode.com/problems/tallest-billboard/?envType=problem-list-v2&envId=50vif4uc">956. Tallest Billboard</a></h2><h3>Hard</h3><hr><p>You are installing a billboard and want it to have the largest height. The billboard will have two steel supports, one on each side. Each steel support must be an equal height.</p>
